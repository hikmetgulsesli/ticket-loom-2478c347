...
export function EmptyState({ actions, activeFilter = "all" }: EmptyStateProps) {
  return (
    <>
      <header>
          <div><div className="meta">Ticket Loom</div><h1>Empty State</h1><p>No tickets match the current {activeFilter} view.</p></div>
        ...
        <main id="fallback-empty-state">
          <section className="command-panel">
            <p>Create a ticket or return to the dashboard to choose another saved view.</p>
            ...
            <div className="data-grid"><article><h2>0</h2><p>Tickets are available in this filtered queue.</p></article><article><h2>{activeFilter}</h2><p>Current filter applied to the workspace.</p></article></div>
          </section></main>
    </>
  );
}
